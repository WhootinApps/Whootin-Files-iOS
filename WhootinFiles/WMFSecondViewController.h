...
@interface WMFSecondViewController : UIViewController<LeveyPopListViewDelegate,QBImagePickerControllerDelegate,MFMailComposeViewControllerDelegate,RNGridMenuDelegate,SListViewDelegate, SListViewDataSource,SwipeViewDelegate, SwipeViewDataSource>
{
